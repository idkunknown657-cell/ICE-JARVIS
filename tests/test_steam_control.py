...
class LocalInstallTests(unittest.TestCase):
    ...
    def test_launch_local_game(self):
        with patch("actions.steam_control._ensure_running", return_value=None), \
    ...
    def test_launch_aborts_when_steam_fails(self):
        with patch("actions.steam_control._ensure_running",
    ...
    def test_purchase_goes_to_confirm_gate(self):
        ...
        with patch("actions.steam_control.confirm", FakeConfirm), \
