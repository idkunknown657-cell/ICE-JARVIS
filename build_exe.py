"""
build_exe.py — build a shareable Windows build of ICE JARVIS in one command.

    py -3.12 build_exe.py            (or double-click build_exe.bat)

What it does:
  1. Runs PyInstaller with ICE.spec  →  dist/ICE/ICE.exe (+ _internal/)
...
README = """\
ICE JARVIS — real-time voice AI companion
==========================================

FIRST RUN
  1. Double-click ICE.exe  (Windows 10/11, microphone and speakers needed).
...
WHAT TO KNOW
  ...
  • Keep the folder together: ICE.exe, _internal/, ui_web/, actions/,
...
def main() -> None:
    ...
    print("   Hand the WHOLE folder to someone (zip it) — they start with ICE.exe.")
